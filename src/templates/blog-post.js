...
const BlogPost = (props) => {
    ...
    return (
        <Layout>
            <div>
                <h2>{props.data.contenfulBlog.title}</h2>
                <p style={{fontWeight: 200, fontSize: "0.8rem"}}>Published {props.data.contenfulBlog.publishedDate}</p>
                <p style={{fontWeight: 300, fontSize: "0.9rem"}}>Written By {props.data.contenfulBlog.author}</p>
                {
                    documentToReactComponents(props.data.contenfulBlog.body.json,options)
                }
